...
urlpatterns = [
    ...
    path('cate-update/<int:pk>/', CategoryView.as_view({'patch':'update'}), name='cate_update'),
    path('cate-details/<int:pk>/', CategoryView.as_view({'get':'details'}), name='cate_details'),
    path('cate-delete/<int:pk>/', CategoryView.as_view({'delete':'destroy'}), name='cate_delete'),
    ...
    path('product-update/<int:pk>/', ProductView.as_view({'patch':'update'}), name='product_update'),
    path('product-details/<int:pk>/', ProductView.as_view({'get':'details'}), name='product_details'),
    path('product-delete/<int:pk>/', ProductView.as_view({'delete':'destroy'}), name='product_delete'),
